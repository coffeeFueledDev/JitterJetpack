...
public class LevelOne extends GameScreen {
    ...
    @Override
    public void show() {
        super.renderer = new WorldRenderer(WorldVars.LEVEL_ONE);
        super.show();
    ...
    public void updateGameWon() {
        super.updateGameWon();
        if(changeLevelWon){
            GameScreen gameScreen = new LevelTwo(super.game);
            super.game.levelSel = LevelVars.LEVEL_TWO;
    ...
    public void restartThisLevel(){
        if(super.restartGame){
            GameScreen restart = new LevelOne(game);
